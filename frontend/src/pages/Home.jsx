...
const Home = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Vibrant screen printing on t-shirts, banners, and promotional materials.',
  ...
  const getServiceImage = (title) => {
    ...
    return `${backendBase}/resources/${map[key]}`
  }
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-900 via-primary-700 to-primary-600">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 py-20 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-100 mb-8 max-w-3xl mx-auto">
            Blantyre's premier printing press.
          </p>
      ...
      <section className="section-padding bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Professional printing and media solutions for your projects</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => {
              const img = getServiceImage(service.title)
              ...
              return (
                <div key={index} className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all">
                      ...
                      {service.features.map((feature, idx) => (
                        <li key={idx} className="flex items-center text-gray-700 text-sm">
                          <svg className="w-4 h-4 text-primary-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 1 1 1.414 1.414l-8 8a1 1 0 0 1-1.414 0l-4-4a1 1 0 1 1 1.414-1.414L8 12.586l7.293-7.293z" clipRule="evenodd" />
                          </svg>
                          {feature}
                        </li>
                      ))}
                  ...
                  <div className="p-4 bg-primary-600 text-center rounded-b-xl">
                    <Link to="/order" className="text-white font-semibold hover:underline">Learn More</Link>
                  </div>
                </div>
              )
            })}
      ...
      <section className="section-padding bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">We deliver excellence</p>
          </div>
      ...
      <section className="section-padding bg-gradient-to-br from-primary-600 to-primary-800 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8">Get in touch for a free consultation</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/order" className="bg-white text-primary-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-all text-lg shadow-lg">Request Quote</Link>
            <Link to="/contact" className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white/10 transition-all text-lg">Contact Us</Link>
          </div>
        </div>
      </section>
